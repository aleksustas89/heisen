                        ...
                        <div class="card-body tab-content">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-6 col-sm-3">
                                    ...
                                    <input type="text" value="{{ $discount->start_datetime }}" name="start_datetime" class="form-control datepicker" placeholder="Действует от">
                                </div>
                                <div class="col-6 col-sm-3">
                                    <label class="mb-1">Действует до</label>
                                    <input type="text" value="{{ $discount->end_datetime }}" name="end_datetime" class="form-control datepicker" placeholder="Действует до">
                                </div>
