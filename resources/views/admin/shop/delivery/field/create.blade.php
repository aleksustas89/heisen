    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card" id="id_content">
                <form action="{{ route('shopDeliveryField.store') }}" method="POST" id="formEdit" enctype="multipart/form-data">
                    ...
                    <div class="card-body tab-content">
                        ...
                        <div class="row mb-3">
                            <div class="col-6"> 
                                ...
                                <input type="text" name="caption" class="form-control form-control-lg" placeholder="Название доставки">
                            </div>
                            <div class="col-6"> 
                                <label class="mb-1 my-2">Название поля в input</label>
                                <input type="text" name="field" class="form-control form-control-lg" placeholder="Название поля в input">
                            </div>
                        </div>
                    ...
                    <div class="card-footer">
                        <input type="hidden" name="shop_delivery_id" value="{{ $shop_delivery_id }}" />
