    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card" id="id_content">
                ...
                <form action="{{ route('shop.shop-item-list-item.update', ['shop' => $shop->id, 'shop_item_list_item' => $list_item->id]) }} " method="POST" id="formEdit" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                                ...
                                <div class="tab-pane active" id="main">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-6 mb-3">
                                            ...
                                            <input id="declension" type="text" value="{{ $list_item->declension }}" name="declension" class="form-control form-control-lg" placeholder="Сео склонение">
                                        </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input id="static_filter_path" type="text" value="{{ $list_item->static_filter_path }}" name="static_filter_path" class="form-control" placeholder="Название для статического фильтра">
                                    </div>
