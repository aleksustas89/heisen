        ...
        <div class="float-start">
            <ol class="breadcrumb">
                @foreach ($breadcrumbs as $breadcrumb)
                    ...
                    @endif
                @endforeach
                <li class="breadcrumb-item">Новый список</li>
            </ol>
        </div>
    </div>
@endsection
                            ...
                            <div class="card-body tab-content">
                                ...
                                <div class="tab-pane active" id="main">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input id="name" type="text" name="name" class="form-control form-control-lg" placeholder="Название списка" data-min="1"  data-max="255" data-required="1">
                                        <div id="name_error" class="fieldcheck-error"></div>
                                    </div>

                                    <div class="mb-3">
                                        <label class="mb-1">Описание</label>
                                        <textarea id="name" type="text" name="description" class="form-control" placeholder="Описание"></textarea>
                                    </div>
