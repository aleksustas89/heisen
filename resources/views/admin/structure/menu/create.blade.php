    ...
    <div class="float-start">
        <ol class="breadcrumb">
            @foreach ($breadcrumbs as $breadcrumb)
                ...
                @endif
            @endforeach
            <li class="breadcrumb-item">Новое меню</li>
        </ol>
    </div>
</div>
                    ...
                    <div class="card-body tab-content">
                        ...
                        <div class="tab-pane active" id="main">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="name" name="name" class="form-control form-control-lg" placeholder="Название меню" data-required="1" data-min="2" data-max="255">
