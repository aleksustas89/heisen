    ...
    <div class="page-title-box d-flex flex-column">
        <div class="float-start">
            <ol class="breadcrumb">
                ...
                @endforeach
                <li class="breadcrumb-item">Редактирование комментария</li>
            </ol>
        </div>
    </div>
@endsection
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card" id="id_content">
                ...
                <form action="{{ route('comment.update', $comment->id) }}" method="POST" id="formEdit" enctype="multipart/form-data">
                    ...
                    <div class="card-body tab-content">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="subject" type="text" name="subject" value="{{ $comment->subject }}" class="form-control form-control-lg" placeholder="Тема" data-min="2"  data-max="255" data-required="1">
                            <div id="subject_error" class="fieldcheck-error"></div>
                        </div>

                        <div class="mb-3">
                            <label class="mb-1">Текст комментария</label>
                            <textarea type="text" name="text" class="form-control" placeholder="Текст комментария">{{ $comment->text }}</textarea>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-12 col-sm-4">
                                ...
                                <div class="form-check form-switch form-switch-success field-check-center">
                                    <div>
                                        <input {{ $comment->active == 1 ? 'checked' : '' }} value="1" class="form-check-input" name="active" type="checkbox" id="active">
