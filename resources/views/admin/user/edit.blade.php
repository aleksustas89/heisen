    ...
    <div class="page-title-box d-flex flex-column">
        <div class="float-start">
            <ol class="breadcrumb">
                ...
                @endforeach
                <li class="breadcrumb-item">Редактирование сотрудника - {{ $user->name }}</li>
            </ol>
        </div>
    </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-4">
                                ...
                                <div class="form-check form-switch form-switch-purple">
                                    <input value="1" {{ $user->active == 1 ? 'checked' : '' }} class="form-check-input" name="active" type="checkbox" id="active">
